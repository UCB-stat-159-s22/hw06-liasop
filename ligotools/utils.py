...
def plot_PSD(time, timemax, SNR, pcolor, det, tevent, strain_whitenbp, template_match, eventname, plottype, template_fft, datafreq, d_eff, template_f, freqs, data_psd, fs):
